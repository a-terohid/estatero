import { 
    ...
    editProfileAgent_interface,
    editProfileAgentError_interface,
...
// Function to validate edit Agent profile form data and return an object containing error messages.
export const editProfileAgentFormsValidation = (
    data: editProfileAgent_interface, 
    date_error: editProfileAgentError_interface
): editProfileAgentError_interface => {
    ...
    // Initializing an error object with previous errors
    let errors: editProfileAgentError_interface = {
        name_error: date_error.name_error,
        last_name_error: date_error.last_name_error,
        phone_number_error : date_error.phone_number_error,
        bio_error : date_error.bio_error,
        short_title_error : date_error.short_title_error,
        license_number_error: date_error.license_number_error , 
        experience_years_error: date_error.experience_years_error
    };
