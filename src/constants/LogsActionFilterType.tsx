...
export const LogsActionFilters = [
  ...
  },
  {
    name: "new blog",
    value: "new blog",
    filter: { action: LogsActions.NEW_BLOG},
  },
   {
    name: "blog published",
  ...
  {
    name: 'blog Testimonials reply added',
    value: 'blog Testimonials reply added',
    filter: { action: LogsActions.NEW_BLOG_TESTIMONIALS_REPLY},
  },
  {
