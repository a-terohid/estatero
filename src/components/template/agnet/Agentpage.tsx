        ...
        <div>
            ...
            <div className=' container py-8 md:py-16 lg:py-24'>
                <div className='md:w-1/2 mb-12'>
                    ...
                    <p className=' text-Body-RL-Small md:text-Body-RL-Medium lg:text-Body-RL-Large mt-2 md:mt-4'>At Estatero, our dedicated agents are here to make your home-buying, selling, or renting journey as seamless as possible.</p>
                </div>
                <ul>
                    <li className='py-6 border-t border-Greyscale-100 flex gap-y-2 md:gap-0 flex-col md:flex-row justify-between'>
                        ...
                        <p className='text-Body-RL-Small md:text-Body-RL-Medium md:w-1/2 lg:w-1/3'>Our agents know your neighborhood inside and out, ensuring you get the best deals tailored to your needs</p>
                    </li>
                    <li className='py-6 border-t border-Greyscale-100 flex gap-y-2 md:gap-0 flex-col md:flex-row justify-between'>
                        <h4 className='text-Heading-5 md:text-Heading-4'>Personalized Service</h4>
                        <p className='text-Body-RL-Small md:text-Body-RL-Medium md:w-1/2 lg:w-1/3'>Every client is unique, and we’re committed to understanding your specific goals and preferences</p>
                    </li>
                    <li className='py-6 border-t border-Greyscale-100 flex gap-y-2 md:gap-0 flex-col md:flex-row justify-between'>
                        <h4 className='text-Heading-5 md:text-Heading-4'>Results-Driven Approach</h4>
                        <p className='text-Body-RL-Small md:text-Body-RL-Medium md:w-1/2 lg:w-1/3'>From negotiations to finalizing deals, our agents work tirelessly to deliver the results you deserve</p>
                    </li>
                    <li className='py-6 border-t border-Greyscale-100 flex gap-y-2 md:gap-0 flex-col md:flex-row justify-between'>
                        <h4 className='text-Heading-5 md:text-Heading-4'>Support Every Step of the Way</h4>
                        <p className='text-Body-RL-Small md:text-Body-RL-Medium md:w-1/2 lg:w-1/3'>Whether you're buying your first home or selling a property, our agents guide you with transparency</p>
                    </li>
                </ul>
                <div className='mt-16 md:mt-32 lg:mt-52'>
                    ...
                    <div className='mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                        {
                            agents.length ? agents.map((agent , index) => <AgentsCard agent={agent} key={index}/>) : <p className='text-Body-MD-Medium mt-5'>No Agent Found!</p>
                        }
                    </div>
                </div>
            </div>
