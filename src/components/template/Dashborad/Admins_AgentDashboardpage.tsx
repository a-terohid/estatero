...
const Admins_AgentDashboardpage = ({ user }: { user: Agent_Interface | User_Interface }) => {
        ...
        <div className='px-5 py-5 md:px-7' >
            ...
            <div className='md:flex gap-x-6 lg:gap-x-8'>
                ...
                <div className='w-full'>
                    ...
                    {/* Dates */}
                    <div className='flex justify-between md:justify-start md:gap-x-5 pb-5 mb-5  border-Greyscale-400'>
                        <p className='text-Body-MD-XSmall md:text-Body-MD-Small'>
                            Register at: 
...
export default Admins_AgentDashboardpage;