        ...
        <div className='flex flex-col gap-y-5'>
            <div className=" text-Body-RL-Small lg:text-Body-RL-Medium">
                ...
                <div className="flex gap-x-2 items-center mb-4">
                    <input
                        ...
                        />
                    <p>Delete and edit thumbnail</p>
                </div>
                {isCheckedCoverImage && <div><input
                    type="file"
                    id="thumbnailInput"
                    accept="image/*"
            ...
            <div className=" text-Body-RL-Small lg:text-Body-RL-Medium">
                ...
                <div className="flex gap-x-2 items-center mb-4">
                    <input
                        type="checkbox"
                        checked={isCheckedFloorPlan}
                        onChange={handleIsCheckedFloorPlan}
                        />
                    <p>Delete and edit floor plan</p>
                </div>
                { isCheckedFloorPlan && <div>
                    <input
                    type="file"
                    id="floorPlanInput"
                    accept="image/*"
            ...
            <div className=" text-Body-RL-Small lg:text-Body-RL-Medium">
                ...
                <div className="flex gap-x-2 items-center mb-4">
                    <input
                        type="checkbox"
                        checked={isCheckedImages}
                        onChange={handleIsCheckedImages}
                        />
                    <p>Delete and edit images</p>
                </div>
                { isCheckedImages && <div>
                    <input
                        type="file"
