...
import AllMessage from '@/template/Dashborad/AllMessage';
...
export const metadata: Metadata = {
    title: "All Messages | Dashboard",
    description:
      "View  All messages in the dashboard. Filter messages by date, email, and more.",
    keywords: [
      "Messages",
      "User Dashboard",
      "Communication",
...
const page = async ({ searchParams }: { searchParams: MyMessagesPageSearchParams_interface }) => {
    ...
    const validRoles = DashboardItems.find(item => item.name === "All messages")?.accessibility;
